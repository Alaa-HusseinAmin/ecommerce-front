    ...
    <>
        <div className='w-50 m-auto my-5'>
         ...
         <form onSubmit={registerFormik.handleSubmit}>
            ...
            <input onBlur={registerFormik.handleBlur} value={registerFormik.values.name} onChange={registerFormik.handleChange} type='text' className='form-control my-3' id='name' name='name'></input>
           ...
           {registerFormik.errors.name && registerFormik.touched.name ?<div className='alert alert-danger'>
            ...
            <input onBlur={registerFormik.handleBlur} value={registerFormik.values.email} onChange={registerFormik.handleChange} type='email' className='form-control my-3' id='email' name='email'></input>
           ...
           {registerFormik.errors.email && registerFormik.touched.email ?<div className='alert alert-danger'>
            ...
            <input onBlur={registerFormik.handleBlur} value={registerFormik.values.password} onChange={registerFormik.handleChange} type='password' className='form-control my-3' id='password' name='password'></input>
            ...
            <input onBlur={registerFormik.handleBlur} value={registerFormik.values.rePassword} onChange={registerFormik.handleChange} type='password' className='form-control my-3' id='rePassword' name='rePassword'></input>
